...
import com.zwhkj.todaynews.todaynews.application.TodayNewsApplication;
...
public class StrUtils {
    ...
    public static String getIpCountry() {
        ...
        try {
            TelephonyManager mTelephonyManager = (TelephonyManager) TodayNewsApplication
    ...
    public static String getIpBaseStation() {
        TelephonyManager telMgr = (TelephonyManager) TodayNewsApplication
                .getInstance().getSystemService(Context.TELEPHONY_SERVICE);
        int cid = 0;
        int lac = 0;
        try {
    ...
    public static String getAndroidId() {
        ...
        return Settings.Secure.getString(TodayNewsApplication.getInstance()
    ...
    public static int getIpAddress() {
        int ipAddress = 0;
        WifiManager wifiManager = (WifiManager) TodayNewsApplication
