...
public class TabWidget extends LinearLayout {
    ...
    private int[] mDrawableIds = new int[]{
            R.drawable.bg_home,R.drawable.bg_video,
            R.drawable.bg_message, R.drawable.bg_me
    };
    ...
    private void init(final Context context) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (i == 0) {
                ...
                itemName.setTextColor(Color.rgb(200, 17, 17));
    ...
    public void setTabsDisplay(Context context, int index) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if ((Integer) (checkedTextView.getTag()) == index) {
                ...
                checkedTextView.setTextColor(Color.rgb(200, 17, 17));
